...
export kdc_realm=${kdc_realm:-WORKSHOP.COM}
...
cd /tmp
git clone https://github.com/Data-drone/masterclass.git  
...
echo "Resource Based Policies import"
...
echo "tag based policies Based Policies import"
